...
//!
//! This module documents the CQC interface specification as defined on
//! https://stephaniewehner.github.io/SimulaQron/PreBetaDocs/CQCInterface.html
//! and defines the necessary pub constants and pub structures.
